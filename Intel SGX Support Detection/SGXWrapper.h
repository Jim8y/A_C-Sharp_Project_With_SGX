...
#ifdef INTELSGXSUPPORTDETECTION_EXPORTS
#define SGXDETECTION_API __declspec(dllexport)
#else
#define SGXDETECTION_API __declspec(dllimport)
#endif
