...
{
	check_sgx_support();
	return ( (sgx_support & (SGX_SUPPORT_YES|SGX_SUPPORT_REBOOT_REQUIRED)) == (SGX_SUPPORT_YES|SGX_SUPPORT_REBOOT_REQUIRED) ) ? 1 : 0;
}

int SGXWrapper::bios_enable_required ()
{
	check_sgx_support();
	return ( (sgx_support & (SGX_SUPPORT_YES|SGX_SUPPORT_ENABLE_REQUIRED)) == (SGX_SUPPORT_YES|SGX_SUPPORT_ENABLE_REQUIRED) ) ? 1 : 0;
}
